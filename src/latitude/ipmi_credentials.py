...
class IPMICredentials:
    ...
    def create_ipmi_session(self, request: operations.CreateIpmiSessionRequest) -> operations.CreateIpmiSessionResponse:
        ...
        res = operations.CreateIpmiSessionResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IpmiSession])
