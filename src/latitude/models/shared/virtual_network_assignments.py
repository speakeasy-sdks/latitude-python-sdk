...
class VirtualNetworkAssignments:
    data: Optional[list[shared_virtual_network_assignment.VirtualNetworkAssignment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data'), 'exclude': lambda f: f is None }})
