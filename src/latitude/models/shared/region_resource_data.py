...
class RegionResourceData:
    ...
    site: Optional[RegionResourceDataSite] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('site'), 'exclude': lambda f: f is None }})
