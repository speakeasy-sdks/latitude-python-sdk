...
class PostProjectUserDataRequestBodyData:
    ...
    attributes: Optional[PostProjectUserDataRequestBodyDataAttributes] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attributes') }})
