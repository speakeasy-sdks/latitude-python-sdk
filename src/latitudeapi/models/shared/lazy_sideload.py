...
@dataclasses.dataclass
class LazySideload:
    meta: Optional[LazySideloadMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})
