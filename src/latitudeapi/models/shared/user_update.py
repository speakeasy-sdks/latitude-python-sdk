...
@dataclasses.dataclass
class UserUpdate:
    attributes: Optional[UserUpdateAttributes] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes'), 'exclude': lambda f: f is None }})
